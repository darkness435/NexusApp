    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        imageReader.setOnImageAvailableListener({ reader ->
            ...
            if (image != null) {
                ...
                // (Görüntü işleme ve ML Kit kodları burada çalışır)
        ...
        scope.launch {
            try {
                ...
                val textView = TextView(this@TranslationOverlayService).apply {
                    ...
                    setBackgroundColor(Color.parseColor("#80000000")) // Yarı saydam siyah arka plan
                }
                windowManager.addView(textView, params)
                delay(3000) // Çeviri 3 saniye ekranda kalır
